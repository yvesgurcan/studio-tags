...
function getCollections(callback, res) {
    if (collections.length > 0) {
        console.log(
            `Collections are already in memory. Collection count: ${
                collections.length
            }`
        );
        if (callback) {
        ...
        getCollections(({ _collections }) => {
            ...
            getToken(_token =>
                errorWrapper(
                    ...
                    axios
                        .get(
                            `${VHS}/internal/collections/by/ids/${
                                collection.id
                            }?populate_videos=false&access_token=${_token}`
                        )
                                                            ...
                                                            .then(
                                                                ({
                                                                    ...
                                                                    console.log(
                                                                        `${
                                                                            missingTags.length
                                                                        } tags were not found in the database.`,
                                                                        {
                                                                            missingTags
                                                                        }
                                                                    );
